  ...
  <div class="site-wrap">
	...
	<div class="main-w3layouts wrapper">
		...
		<div class="main-agileinfo">
			...
			<div>${msg}</div>
				<form action="adduser1" onsubmit="return validateit()"  method="post">
					...
					<input class="text w3lpass" type="password" name="re_pass" id="re_pass" placeholder="Confirm Password" required>
					...
					<input type="submit" href="index"value="SIGNUP">
				</form>

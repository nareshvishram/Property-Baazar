...
<title>RoomSpace &mdash; </title>
    ...
    <style>
     body{
       background-image:linear-gradient(rgba(0,0,0,0.9), rgba(0,0,0,0)), url("images/tanent.jpg");
...
<form class="row mb-5" action="getProperty">
          ...
          <div class="col-sm-6 col-md-4 col-lg-3 mb-4">
           ...
           <div class="col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="select-wrap">
              <span class="icon icon-arrow_drop_down"></span>
              <select name="nearBy" id="offer-types" class="form-control d-block rounded-0">
                <option value="">NearBy Places</option>

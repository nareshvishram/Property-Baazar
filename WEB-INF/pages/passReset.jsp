	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: url(images/forget.png);">
				...
				<form action="passResetMail" class="login100-form validate-form" method="post">
					...
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						...
						<input class="input100" type="password" name="confirmpass" placeholder="Enter Confirm password">
						<span class="focus-input100"></span>
					</div>
